...
> 最近更新：2026-08-10（**SFT 优先级提前为下一课**，用户拍板；此前 L11/L12/Langfuse 已封版）
...
| 模型后训练 **SFT ⬆️已提前为下一课（2026-08-10 用户拍板，只取 SFT/LoRA 层）** / RL(PPO/DPO)、工具内化仍留此池 | 🟩 | **Ch7**（16 项目） | JD3 加分 |
...
7. 🚧 **SFT 微调专项**（书 Ch7，**2026-08-10 用户拍板提前，下一个主推**；小模型 LoRA + 复用 eval/rubric_judge 做 before/after 闭环）。🟩
8. ⬜ **L13 可观测/成本/延迟 + Harness** · **L14 部署深化**（顺延）。🟦
