...
- 起始日期 / 最近更新：2026-07-13 / 2026-07-27（**L8 封版 + 作业教学法升级为「带着盖楼」**）
...
- **立刻要做**：**L8 已封版，且已于 2026-07-27 补做架构蓝图复盘（用户已理解多文件结构）**。
  下一步有两个选项，由用户开口决定（别抢跑）：
  ...
  ⚠️ **无论选哪个，作业一律用新的「带着盖楼」教学法**（见上方「🔴 教学标准变更②」+
  `COURSE-OVERVIEW-v3.md` §三·补三）：先讲蓝图 → 给"工具层→核心循环→编排层→入口→测试"结构模板 →
  从空文件一小块一小块带着写 → 纵切先跑通再加厚；单节 TODO ≤~10–12、别跨文件链式依赖。
  **L9 尤其适用**：LangChain 重写必然是多文件，正好用蓝图先行帮他建立框架级的整体结构认知。
